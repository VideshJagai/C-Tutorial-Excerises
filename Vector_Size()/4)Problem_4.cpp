...
*/
     // C++ Program that creates an empty vector and prints the size
     ...
     /*
          In this program, a vector declared with no elements, and on executing 
          the code, the size of the vector will be displayed as 0.
     */ 
