...
*/
     // C++ Program that inserts element to vector end and printing size..
     ...
     /*
          In this program, an empty vector is declared first and afterwards
          elements are added to the end of the vector using insert().
          
          Then, the size of the vector is printed using size() function.
     */ 
